...
// ============================================================
// CHIBI XL SPRITES (36-wide, drawn at spriteScale 1) — crisp + detailed.
// Keys: i eye-white, w shine, e pupil, G glasses, H hair-shadow, d blush,
//   k body-shadow, B body-highlight, c crown, g dark, m mouth.
// ============================================================
const LEGS_B_STAND = [
  '............llll...llll.............',
  '............llll...llll.............',
...
const MANAGER_BD = [
  ...
  '.....hhhHHHHHHHHHHHHHHHHHHHHhhh.....',
  '....hhhhssssssssssssssssssHHhhh.....',
  '....hhhsssssssssssssssssssssshhh....',
  '....hhsssssssssssssssssssssssshh....',
  '....hhsssssssssssssssssssssssssh....',
  '....hhssGGGGGGGsssssGGGGGGGsssh.....',
  '......hhsGiiiiiGsssGiiiiiGssh.......',
  '......hhsGiweeiGsssGieewiGssh.......',
  '......hhsGieeeiGsssGieeeiGssh.......',
  '......hhsGiiiiiGsssGiiiiiGssh.......',
  '....hhssGGGGGGGsssssGGGGGGGsssh.....',
  '....hhsssssddsssssssssddssssssh.....',
  '....hhssssssssssmmmmsssssssssssh....',
  '....hhsssssssssssssssssssssssssh....',
  '.....hhsssssssssssssssssssssshh.....',
  '.....hhhsssssssssssssssssssshhh.....',
  '....hhhsssssssssssssssssssssshhh....',
  '....hhhsssssssssssssssssssssshhh....',
  '....hhhsssssssssssssssssssssshhh....',
  '............wwwwwwwwwwww............',
...
const JAMESMIE_BD = [
  ...
  '....hhsssssssssssssssssssssssshh....',
  '....hhsssssssssssssssssssssssssh....',
  '.....hhsssHHHHsssssssHHHHssssh......',
  '......hhssiiiiisssssiiiiisssh.......',
  '......hhssiweeisssssieewisssh.......',
  '......hhssieeeisssssieeeisssh.......',
  '......hhssiiiiisssssiiiiisssh.......',
  '.....hhsssssssssssssssssssssssh.....',
  '....hhsssssddsssssssssddssssssh.....',
  '....hhssssssssssmmmmsssssssssssh....',
  '....hhsssssssssssssssssssssssssh....',
  '.....hhsssssssssssssssssssssshh.....',
...
const SPRITES_MANAGER2 = {
  down: { stand: [...MANAGER_BD, ...LEGS_B_STAND], walk1: [...MANAGER_BD, ...LEGS_B_WALK1], walk2: [...MANAGER_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...MANAGER_BU, ...LEGS_B_STAND], walk1: [...MANAGER_BU, ...LEGS_B_WALK1], walk2: [...MANAGER_BU, ...LEGS_B_WALK2] },
};
const SPRITES_JAMESMIE2 = {
  down: { stand: [...JAMESMIE_BD, ...LEGS_B_STAND], walk1: [...JAMESMIE_BD, ...LEGS_B_WALK1], walk2: [...JAMESMIE_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...JAMESMIE_BU, ...LEGS_B_STAND], walk1: [...JAMESMIE_BU, ...LEGS_B_WALK1], walk2: [...JAMESMIE_BU, ...LEGS_B_WALK2] },
};
const SPRITES_READER2 = {
  down: { stand: [...READER_BD, ...LEGS_B_STAND], walk1: [...READER_BD, ...LEGS_B_WALK1], walk2: [...READER_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...READER_BU, ...LEGS_B_STAND], walk1: [...READER_BU, ...LEGS_B_WALK1], walk2: [...READER_BU, ...LEGS_B_WALK2] },
};
const SPRITES_CODER2 = {
  down: { stand: [...CODER_BD, ...LEGS_B_STAND], walk1: [...CODER_BD, ...LEGS_B_WALK1], walk2: [...CODER_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...CODER_BU, ...LEGS_B_STAND], walk1: [...CODER_BU, ...LEGS_B_WALK1], walk2: [...CODER_BU, ...LEGS_B_WALK2] },
};
const SPRITES_SEARCHER2 = {
  down: { stand: [...SEARCHER_BD, ...LEGS_B_STAND], walk1: [...SEARCHER_BD, ...LEGS_B_WALK1], walk2: [...SEARCHER_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...SEARCHER_BU, ...LEGS_B_STAND], walk1: [...SEARCHER_BU, ...LEGS_B_WALK1], walk2: [...SEARCHER_BU, ...LEGS_B_WALK2] },
};
const SPRITES_WRITER2 = {
  down: { stand: [...WRITER_BD, ...LEGS_B_STAND], walk1: [...WRITER_BD, ...LEGS_B_WALK1], walk2: [...WRITER_BD, ...LEGS_B_WALK2] },
  up:   { stand: [...WRITER_BU, ...LEGS_B_STAND], walk1: [...WRITER_BU, ...LEGS_B_WALK1], walk2: [...WRITER_BU, ...LEGS_B_WALK2] },
};
